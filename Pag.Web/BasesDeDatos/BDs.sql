...
-- 1️⃣ BASE DE DATOS
-- ======================================================
CREATE DATABASE IF NOT EXISTS escuela1;
USE escuela1;
...
ALTER TABLE PAGOS 
MODIFY COLUMN RFC_EMP VARCHAR(13) NOT NULL AFTER REEMBOLSO;

ALTER TABLE PAGOS 
MODIFY COLUMN TIPO_CONTRATACION VARCHAR(10) NOT NULL AFTER FECHA_PAGO;
-- ======================================================
...
INSERT INTO PAGOS (RFC_CLIENTE, FECHA_PAGO, TIPO_CONTRATACION, TOTAL_PAGO, FORMA_PAGO, REEMBOLSO, RFC_EMP)
VALUES
('JUAP910101HDF', '2025-06-01', 'BÁSICO', 2000, 'EFECTIVO', FALSE, 'FERJ850715HDF'),
('MARG920202MDF', '2025-06-05', 'PREMIUM', 5000, 'TRANSFERENCIA', FALSE, 'RAMC880908MDF'),
('LUIC930303HDF', '2025-06-10', 'INTERMEDIO', 3500, 'DÉBITO', TRUE, 'FERJ850715HDF'),
('SAND940404MDF', '2025-06-12', 'PREMIUM', 5000, 'EFECTIVO', FALSE, 'RAMC880908MDF'),
('CARF950505HDF', '2025-06-15', 'BÁSICO', 2000, 'TRANSFERENCIA', FALSE, 'FERJ850715HDF'),
('ANEL960606MDF', '2025-06-18', 'INTERMEDIO', 3500, 'CRÉDITO', TRUE, 'RAMC880908MDF'),
('JORR970707HDF', '2025-06-20', 'PREMIUM', 5000, 'TRANSFERENCIA', FALSE, 'FERJ850715HDF'),
('LUIM980808MDF', '2025-06-22', 'BÁSICO', 2000, 'EFECTIVO', TRUE, 'RAMC880908MDF'),
('RAFM990909HDF', '2025-06-25', 'INTERMEDIO', 3500, 'CRÉDITO', FALSE, 'FERJ850715HDF'),
('VERC000101MDF', '2025-06-28', 'PREMIUM', 5000, 'TRANSFERENCIA', FALSE, 'RAMC880908MDF'),
('OSCJ010202HDF', '2025-06-30', 'BÁSICO', 2000, 'EFECTIVO', FALSE, 'FERJ850715HDF');
