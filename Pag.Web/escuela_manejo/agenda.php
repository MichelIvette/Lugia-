    ...
    document.querySelectorAll('.fila-checkbox').forEach(checkbox => {
      checkbox.addEventListener('change', function() {
        ...
        if (this.checked && document.querySelectorAll('.fila-checkbox:checked').length === 1) {
          ...
          modal.querySelector('input[name="fecha_pago"]').value = celdas[5].textContent;
          modal.querySelector('input[name="actividad"]').value = celdas[6].textContent;
          modal.querySelector('input[name="km_recorridos"]').value = celdas[7].textContent;
          modal.querySelector('input[name="exam_teo"]').value = celdas[9].textContent;
          modal.querySelector('input[name="exam_prac"]').value = celdas[10].textContent;
          modal.querySelector('textarea[name="notas"]').value = celdas[8].textContent;
          modal.querySelector('textarea[name="notas_resultado"]').value = celdas[11].textContent;
        }
      });
    });
