        ...
        <tbody>
          ...
          try {
              ...
              while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                  $checkboxValue = $row['RFC_CLIENTE'] . "|" . $row['FECHA_PAGO'];
                  echo "<tr>";
                  echo "<td><input type='checkbox' name='seleccionados[]' value='".htmlspecialchars($checkboxValue)."' class='fila-checkbox'></td>";
        ...
        <form method="POST" action="pago_agregar.php">
          ...
          <div class="modal-body row g-3">
            ...
            <div class="col-md-6">
              ...
              <input type="date" class="form-control" name="fecha_pago" max="<?= date('Y-m-d') ?>" required>
            </div>

            <div class="col-md-6">
              <label class="form-label">Tipo de Contratación</label>
              <select class="form-select" name="tipo_contratacion" id="tipo_contratacion" required>
            ...
            document.getElementById('tipo_contratacion').addEventListener('change', function() {
                document.getElementById('total_pago').value = precios[this.value] || '';
            });
            </script>
      ...
      <div class="modal-content">
        <form method="POST" action="pago_modificar.php">
          ...
          <div class="modal-body">
            ...
            <input type="hidden" name="fecha_pago" id="fecha_pago_mod">
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  checkboxes.forEach(chk => {
    chk.addEventListener('change', () => {
      checkboxes.forEach(c => c !== chk && (c.checked = false));
  ...
  btnModificar.addEventListener('click', () => {
    ...
    const checkboxValue = seleccionado.querySelector('.fila-checkbox').value;
    const [rfc, fecha] = checkboxValue.split('|');

    document.getElementById('rfc_cliente_mod').value = rfc;
    document.getElementById('fecha_pago_mod').value = fecha;
