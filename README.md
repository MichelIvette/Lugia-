...
|------|--------|-----------|---------|
| ![Login](https://github.com/MichelIvette/Lugia-/blob/main/Images/Login.png) | ![Inicio](assets/Inicio.png) | ![Empleados](assets/Empleados.png) | ![Alumnos](assets/Agenda.png) |
